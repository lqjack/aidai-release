...
//import com.hl.qlc.base.freemarker.FreemarkerUtil;
...
public class StringUtils extends org.apache.commons.lang.StringUtils {
	 ...
	 * @return: String
	 */
	public static String getSimpleName(String fullName, boolean isLowerCase,String separate) {
		if (StringUtils.isBlank(fullName)) {
			return null;
		}
		StringBuilder preFullName = new StringBuilder(
				fullName.substring(StringUtils.lastIndexOf(fullName, separate) + 1, StringUtils.length(fullName)));
		if (isLowerCase) {
			return preFullName.substring(0, 1).toLowerCase() + preFullName.substring(1);
		}
		return preFullName.substring(0, 1) + preFullName.substring(1);
	}
	/**
	 * 
	 * @Title: getTrimBlank 
	 ...
	 * @return: boolean
	 */
	public static boolean getTrimBlank(String str){
	...
	public static boolean getArrayTrimBlank(String... strs){
		for(String str:strs){
			return getTrimBlank(str);
		}
		return true;
	}
	
	public static boolean getTrimBlank(String... strs){
		for(String str:strs) {
			if(!getTrimBlank(str))continue;
			else return false;
		}
		return true;
	}
	...
	/*public static String fillTemplet(String template){
		...
		Map<String,Object> data=ThreadLocalMap.getThreadLocalMap();
		try {
